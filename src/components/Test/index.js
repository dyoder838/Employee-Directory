...
const headCells = [
  { id: 'image', numeric: false, disablePadding: false, label: "Photo"},
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left" src={row.image} component="th" id={labelId} scope="row" padding="none">
                      <img src={row.image} alt="employee" />
                      </TableCell>
